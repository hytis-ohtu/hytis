...
describe("/api/rooms", () => {
  ...
  describe("GET /api/rooms", () => {
    it("rooms data is returned as json", async () => {
      await api
        .get("/api/rooms")
        .expect(200)
    ...
    it("single room is returned", async () => {
    ...
    it("returns 404 for non-existing room", async () => {
  ...
  describe("PUT /api/rooms/:id", () => {
    ...
    it("normalizes empty freeText string to null", async () => {
      const updatedRoomData = {
        capacity: 10,
        departmentId: 1,
        freeText: "",
